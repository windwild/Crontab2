...
*/
    ...
    define('CRON_CI_INDEX', '??????????????????????');   // Your CodeIgniter main index.php file
...
# Parse the command line
    ...
    $usage = "Usage: cron.php --run=/controller/method [--show-output][-S]
     [--log-file=logfile] [--time-limit=N] [--server=http_server_name]\n\n";
